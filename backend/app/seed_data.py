"""
Canonical High Guard 2022 ship data — seeded automatically on first boot
if the ships table is empty.
"""
...
SHIPS = [
    {
        "ship": dict(
            ...
            bridge_type="cockpit", computer_model="Computer/5", computer_processing=5,
            ...
            cargo_tons=0, hardpoints=0, total_cost_mcr=6.33,
            description="Tiny 6-ton carrier-based fighter. Carried in flights of four. Fast but fragile — any serious resistance ends it.",
        ),
        "weapons": [
            dict(name="Fixed Pulse Laser", count=1, mount="fixed", weapon_type="pulse_laser",
    ...
    },
    {
        "ship": dict(
            ...
            staterooms=0, staterooms_double=0, low_berths=0,
            emergency_low_berths=0, common_area_tons=0,
            cargo_tons=1, hardpoints=0, total_cost_mcr=9.62,
            description="10-ton light fighter. Fast and highly manoeuvrable. Improved sensors. Pulse laser on a fixed mount.",
        ),
        "weapons": [
            dict(name="Fixed Pulse Laser", count=1, mount="fixed", weapon_type="pulse_laser",
                 tl=9, power=3, damage_dice=2, damage_dm=0, damage_multiple=1,
    ...
    },
    {
        "ship": dict(
            ...
            fuel_tons_jump=0, fuel_tons_reaction=1,
            bridge_type="standard", computer_model="Computer/5", computer_processing=5,
            computer_bis=False, computer_fib=False,
            ...
            emergency_low_berths=0, common_area_tons=0,
            cargo_tons=2, hardpoints=0, total_cost_mcr=13.67,
            description="Armoured 20-ton gig carried on the Gazelle Close Escort. Thrust 8, Bonded Superdense armour, Stealth.",
        ),
        "weapons": [
            dict(name="Fixed Pulse Laser (Intense Focus, High Yield)", count=1,
    ...
    },
    {
        "ship": dict(
            ...
            emergency_low_berths=0, common_area_tons=0,
            cargo_tons=11, hardpoints=1, total_cost_mcr=36.94,
            description="Iconic 100-ton IISS multi-role scout. Thousands in service. Jump-2, Thrust 2. Carries an air/raft.",
        ),
        "weapons": [
            dict(name="Double Turret (Pulse Laser)", count=1, mount="double_turret",
                 weapon_type="pulse_laser",
    ...
    },
    {
        "ship": dict(
            ...
            cargo_tons=7, hardpoints=1, total_cost_mcr=40.97,
            description="TL14 upgrade of the Type S. Bonded Superdense armour, advanced probe drones, aerofins, life scanner. Allotted to senior scouts.",
        ),
        "weapons": [
            dict(name="Double Turret (Pulse Laser)", count=1, mount="double_turret",
                 weapon_type="pulse_laser",
    ...
    },
    {
        "ship": dict(
            ...
            description="Common 200-ton far trader encountered anywhere in the Imperium. Jump-2, Thrust 1. Two double beam laser turrets.",
        ),
        "weapons": [
            dict(name="Double Turret (Beam Lasers)", count=2, mount="double_turret",
                 weapon_type="beam_laser",
    ...
    },
    {
        "ship": dict(
            ...
            bridge_type="standard", computer_model="Computer/35", computer_processing=35,
            computer_bis=False, computer_fib=False,
            sensor_type="improved", sensor_dm=1,
            ...
            cargo_tons=14, hardpoints=2, total_cost_mcr=134.44,
        ...
        "weapons": [
            dict(name="Triple Turret (Beam Lasers)", count=1, mount="triple_turret",
                 weapon_type="beam_laser",
                 tl=10, power=4, damage_dice=1, damage_dm=2, damage_multiple=1,
                 traits=[], ammo_count=0, pop_up=False),
            dict(name="Triple Turret (Missile Racks)", count=1, mount="triple_turret",
                 weapon_type="missile_rack",
    ...
    },
    {
        "ship": dict(
            ...
            bridge_type="small", computer_model="Computer/20", computer_processing=20,
            computer_bis=True, computer_fib=False,
            sensor_type="military", sensor_dm=0,
            ...
            cargo_tons=12, hardpoints=4, total_cost_mcr=188.57,
        ...
        "weapons": [
            dict(name="Particle Barbettes", count=2, mount="barbette",
                 weapon_type="particle_barbette",
                 tl=11, power=15, damage_dice=4, damage_dm=0, damage_multiple=3,
                 traits=["Radiation"], ammo_count=0, pop_up=False),
            dict(name="Triple Turret (Intense Focus Beam Lasers)", count=2, mount="triple_turret",
                 weapon_type="beam_laser",
                 tl=10, power=4, damage_dice=1, damage_dm=2, damage_multiple=1,
                 traits=[], ammo_count=0, pop_up=False),
        ],
    },
    {
        "ship": dict(
            ...
            bridge_type="small", computer_model="Computer/30", computer_processing=30,
            computer_bis=False, computer_fib=False,
            ...
            cargo_tons=5, hardpoints=4, total_cost_mcr=254.9,
            description="400-ton Imperial Navy fast courier. Jump-5, Thrust 5 (energy efficient). Advanced sensors, Evade/3, Fire Control/4.",
        ),
        "weapons": [
            dict(name="Triple Turret (Beam Lasers)", count=2, mount="triple_turret",
                 weapon_type="beam_laser",
                 tl=10, power=4, damage_dice=1, damage_dm=2, damage_multiple=1,
                 traits=[], ammo_count=0, pop_up=False),
            dict(name="Triple Turret (Sandcasters)", count=2, mount="triple_turret",
                 weapon_type="sandcaster",
...
async def run_seed(db):
    ...
    print("  Seeding canonical High Guard 2022 ships...")
    for entry in SHIPS:
